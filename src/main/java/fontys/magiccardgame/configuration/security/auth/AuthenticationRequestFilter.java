package fontys.magiccardgame.configuration.security.auth;
...
import fontys.magiccardgame.configuration.security.token.exception.InvalidAccessTokenException;
